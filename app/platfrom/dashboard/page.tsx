...
export default function PlatformDashboardPlaceholderPage() {
    ...
    <main className="min-h-screen bg-[#f5fbff] text-[#003F60] px-6 py-16">
      <div className="max-w-3xl mx-auto">
        <PlatformDashboardGate
          ...
          title={translate(locale, "platform.dashboard.title")}
          subtitle={translate(locale, "platform.dashboard.subtitle")}
        />
      </div>
    </main>
  );
